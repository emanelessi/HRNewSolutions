...
Route::get('/admin/holiday', [Admin\HolidayController::class, 'index']);
Route::get('/admin/holiday/add', [Admin\HolidayController::class, 'add']);
...
Route::get('/admin/job', [Admin\JobController::class, 'index']);
Route::get('/admin/job/add', [Admin\JobController::class, 'add']);
Route::get('/admin/job/add', [Admin\JobController::class, 'addJob']);
...
Route::get('/admin/project/add', [Admin\ProjectController::class, 'addProject']);
...
Route::get('/admin/reward', [Admin\RewardController::class, 'index']);
Route::get('/admin/reward/add', [Admin\RewardController::class, 'add']);
Route::get('/admin/reward/add', [Admin\RewardController::class, 'addReward']);
...
Route::get('/admin/check/add', [Admin\CheckController::class, 'create']);
...
Route::get('/admin/department', [Admin\DepartmentController::class, 'index']);
...
Route::get('/admin/department/add', [Admin\DepartmentController::class, 'create']);
